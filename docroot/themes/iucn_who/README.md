...
first `bootstrap` directory (e.g. `./iucn_who/bootstrap/bootstrap`), remove the
...
## Overrides {#overrides}
The `./iucn_who/less/variable-overrides.less` file is generally where you will
the majority of your time overriding the variables provided by the [Bootstrap
Framework].

The `./iucn_who/less/bootstrap.less` file is nearly an exact copy from the
...
The `./iucn_who/less/overrides.less` file contains various Drupal overrides to
properly integrate with the [Bootstrap Framework]. It may contain a few
enhancements, feel free to edit this file as you see fit.

The `./iucn_who/less/style.less` file is the glue that combines the
...
`./iucn_who/css/styles.css` (note the same file name, using a different
extension of course).
