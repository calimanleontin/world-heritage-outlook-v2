(function ($) {
    ...
    attach: function (context) {
      ...
      $(context).find('[data-horizontal-tabs-panes]').once('horizontal-tabs').each(function () {
        ...
        if (!tab_focus) {
          ...
          if (tab != "" && $('#'+tab, this).length) {
            tab_focus = $('#'+tab, this).closest('.horizontal-tabs-pane');
          }
          else {
  ...
  Drupal.theme.horizontalTab = function (settings) {
    ...
    var diff_tabs = drupalSettings.iucn_assessment.diff_tabs;
    var hasDiff = idAttr.replace('-', '_') in diff_tabs;
