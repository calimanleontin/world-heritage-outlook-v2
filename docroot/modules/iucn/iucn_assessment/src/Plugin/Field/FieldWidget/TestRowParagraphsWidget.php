 ...
 *
 * @FieldWidget(
 *   id = "test_row_entity_reference_paragraphs",
 *   label = @Translation("Test Paragraphs row"),
 ...
 * )
 */
class TestRowParagraphsWidget extends ParagraphsWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $this->headers = array_keys($components);
  ...
  public function formMultipleElements(FieldItemListInterface $items, array &$form, FormStateInterface $form_state) {
    ...
    if (!empty($this->headers)) {
      $header_components = $this->headers;
      ...
      $header = [
        'top' => [
          '#type' => 'container',
          '#weight' => -2000,
          '#attributes' => ['class' => ['paragraph-top paragraph-header'],
          ],
  ...
  public function getSummaryContainers($components) {
    $containers = [];
    ...
    foreach ($components as $key => $component) {
      $containers[$key] = [
        '#type' => 'container',
        '#attributes' => ['class' => ['paragraph-summary-component', "paragraph-summary-component-$index-$total"]],
        'data' => ['#markup' => $component],
      ];
      if ($key === 'actions') {
