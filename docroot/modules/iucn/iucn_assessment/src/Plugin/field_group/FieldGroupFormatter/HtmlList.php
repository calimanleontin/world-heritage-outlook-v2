...
/**
 * Plugin implementation of the 'html_list' formatter.
 *
 * @FieldGroupFormatter(
 *   id = "html_list",
 *   label = @Translation("HTML List"),
 *   description = @Translation("Html list."),
 *   supported_contexts = {
 *     "view",
 *   }
 * )
 */
class HtmlList extends FieldGroupFormatterBase {
  ...
  public function preRender(&$element, $rendering_object) {
    ...
    foreach (Element::children($element) as $element_name) {
      $items[] = $element[$element_name];
      unset($element[$element_name]);
    }

    $element['#type'] = 'field_group_html_element_list';
    $element['#theme'] = 'field_group_html_element_list';
