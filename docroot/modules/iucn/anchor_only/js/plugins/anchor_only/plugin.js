...
( function() {
    CKEDITOR.plugins.add( 'anchor_only', {
        requires: 'dialog,fakeobjects',
        // jscs:disable maximumLineLength
        icons: 'anchor_only,anchor_only-rtl', // %REMOVE_LINE_CORE%
        hidpi: true, // %REMOVE_LINE_CORE%
        onLoad: function() {
            // Add the CSS styles for anchor placeholders.
            var iconPath = CKEDITOR.getUrl( this.path + 'images' + ( CKEDITOR.env.hidpi ? '/hidpi' : '' ) + '/anchor_only.png' ),
        ...
        init: function( editor ) {
            ...
            if ( editor.ui.addButton ) {
                editor.ui.addButton( 'anchor_only', {
                    label: 'Anchor',
                    command: 'anchor',
                    toolbar: 'links,30'
                } );
