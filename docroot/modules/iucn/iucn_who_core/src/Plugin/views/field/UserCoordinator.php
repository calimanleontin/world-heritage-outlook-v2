...
/**
 * @file
 * Definition of Drupal\iucn_who_core\Plugin\views\field\UserCoordinator
 */
 ...
 *
 * @ViewsField("iucn_who_core_coordinator")
 */
class UserCoordinator extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    if (!$nodes) {
      ...
      foreach ($view->result as $row) {
        ...
        if (!$row->field_coordinator_users_field_data_nid) {
          continue;
        }
